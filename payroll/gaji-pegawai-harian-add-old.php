        ...
        <div class="kt-container  kt-container--fluid ">
           ...
           <div class="kt-subheader__toolbar">
			<div class="dropdown dropdown-inline" ddata-placement="left">
				<a href="gaji-pegawai-harian.php" class="btn btn-label-brand btn-sm">
										...
										<div class="kt-portlet__body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-5">
														...
														<input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Daeng Kebo">
													</div>
													<div class="col-lg-4">
...
<div class="input-group-append">
 <span class="input-group-text"><i class="la la-calendar-check-o"></i></span></div> </div>
												...
												<div class="col-lg-3">
														...
														<input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Infrastructure">

												</div>

												<div class="col-lg-5">
														<label>Jabatan :</label>
														<input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Civil Engineering">
													</div>
													<div class="col-lg-4">
														<label>Kantor :</label>
							...
							<br>
										<div class="kt-portlet__body">
											...
											<div class="col-lg-3">
														...
														<div class="input-group-append"><span class="input-group-text " id="basic-addon2">Jam</span></div>
