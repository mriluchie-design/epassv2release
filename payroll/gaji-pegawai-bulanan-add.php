        ...
        <div class="kt-container  kt-container--fluid ">
           ...
           <div class="kt-subheader__toolbar">
			<div class="dropdown dropdown-inline" ddata-placement="left">
				<a href="data-gaji-pegawai-tetap.php" class="btn btn-label-brand btn-sm">
...
<div class="input-group-append">
 <span class="input-group-text"><i class="la la-calendar-check-o"></i></span></div> </div>
								...
								<div class="col-xl-12">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Daftar Pegawai Penerima Penghasilan</div><br>
							<br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" bgcolor="#f7fcff">Periode Gaji</th>
											  ...
											  <th width="8%" bgcolor="#f7fcff">Divisi</th>
