												...
												<table class="table table-bordered table-hover table-checkable" id="kt_repeater_1">
																								...
																								<tr style="text-align:center">
																								  <td width="1%" bgcolor="#f7fcff">No</td>
																									...
																									<td width="20%" bgcolor="#f7fcff">Biaya Satuan</td>
																									<td width="20%" bgcolor="#f7fcff">Nominal</td>
																								  </tr>
																								<thead>
...
<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
                              ...
                              <option value="HI">m</option>
														...
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="5.500.000" aria-describedby="basic-addon1">
...
<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
                              ...
                              <option value="HI">m</option>
																									...
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="4.950.000" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div></td>
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
...
<tr>
						                              ...
						                              <option value="3">Tunjangan Hari Raya</option>
																					...
																					<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
																									...
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="495.000" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div></td>
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
						                              ...
						                              <option value="3">Tunjangan Hari Raya</option>
																					...
																					<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
																									...
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="2.508.200" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div></td>
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
...
<tr>
						                              ...
						                              <option value="3">Tunjangan Hari Raya</option>
																					...
																					<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
																									...
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm"  placeholder="3.124.000" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div></td>
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
						                              ...
						                              <option value="3">Tunjangan Hari Raya</option>
																					...
																					<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
																									...
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="2.500.000" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div></td>
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
						                              ...
						                              <option value="3">Tunjangan Hari Raya</option>
																					...
																					<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
																									...
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="2.200.000" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div></td>
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
						                              ...
						                              <option value="3" selected>Tunjangan Representasi</option>
																					...
																					<option data-content="<span class='btn btn-sm m-button-add'><i class='fa fa-plus-circle'></i> Tambah Data</span>" class="select-option-add" value="add"></option>
																									...
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" placeholder="14.894.040" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div></td>
																									<td style="text-align:center"><div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
                        ...
                        <div id="kt_repeater_6">
												<table class="table table-bordered table-hover table-checkable" id="kt_repeater_6">
																								...
																								<tr style="text-align:center">
																								  <td width="1%" bgcolor="#f7fcff">No</td>
																									<td width="6%" bgcolor="#f7fcff">Parameter Potongan</td>
																									<td width="30%" bgcolor="#f7fcff">Nominal</td>
																								  </tr>
																								</thead>
                                                <tbody data-repeater-list="">
																								  <td style="text-align:center">1</td>
