				...
				<form class="kt-form">
					<div class="kt-portlet__body">
                        <div class="form-group row">
							...
							<div class="col-lg-2">
                                <label class="">Parameter Potongan :</label>
								  <select class="form-control kt-selectpicker" data-live-search="true">
                                      <option value="2" selected="">Keterlambatan</option>
                                      <option value="2">Absen</option>
                                      <option value="2">PPH 21</option>
                                      <option value="2">JHT</option>
                                      <option value="2">JKK</option>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="m_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff">Periode</th>
												<th width="22%" bgcolor="#fdfdec">Parameter Potongan</th>
												<th width="7%" bgcolor="#fdfdec">Total Potongan</th>
										...
										<tbody>
											<tr>
											  ...
											  <td style="text-align:center" nowrap><div class="kt-widget2__actions">
															  ...
															  <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																  <ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="laporan-detail-potongan.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td id="kt_table_1">2025</td>
												<td id="kt_table_1">November</td>
												<td nowrap="nowrap" style="text-align:left">JHT</td>
												<td nowrap="nowrap" style="text-align:left"><div class="input-group input-group-sm">
																					    <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																					    <input style="text-align:right" type="text" class="form-control form-control-sm" disabled="disabled" placeholder="2.232.344" aria-describedby="basic-addon1" />
																					    <div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
										  ...
										  <tr>
										    ...
										    <td nowrap="nowrap" style="text-align:center"><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="modal" data-target="#modal_persetujuan_release"data-html="true"> <i class="fa flaticon2-check-mark"></i></span></td>
										    <td nowrap="nowrap" style="text-align:center"><button type="button" class="btn btn-info btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Terbayar&lt;hr&gt;Muhammad Nasrullah, S.Kom&lt;hr&gt;Staff Keuangan&lt;hr&gt;31 Desember 2018 - 14:30 WITA"><i class="fa fa-money-bill-alt"></i></button></td>
