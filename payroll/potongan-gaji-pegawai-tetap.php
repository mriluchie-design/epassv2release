    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="add-potongan-gaji-pegawai-tetap.php" class="btn btn-info btn-sm">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="10%" bgcolor="#f7fcff">Nama Potongan</th>
											  <th width="3%" bgcolor="#f7fcff">Kode Potongan</th>
										...
										<tbody>
											<tr>
												...
												<td width="3%" style="text-align:left" nowrap>Keterlambatan</td>
												<td width="1%" style="text-align:center" nowrap>KTB</td>
												...
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-potongan-gaji-pegawai-tetap.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="edit-potongan-gaji-pegawai-tetap.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="hapus-potongan-gaji-pegawai-tetap.php" class="kt-nav__link" id="kt_sweetalert_demo_9">
										  ...
										  <tr>
												...
												<td width="3%" style="text-align:left" nowrap>Absen</td>
												<td width="1%" style="text-align:center" nowrap>ABS</td>
												<td width="3%" style="text-align:center" nowrap>-</td>
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
										  ...
										  <tr>
												...
												<td width="3%" style="text-align:left" nowrap>PPH 21</td>
												<td width="1%" style="text-align:center" nowrap>PPH</td>
												<td width="3%" style="text-align:center" nowrap>-</td>
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
										  ...
										  <tr>
												...
												<td width="3%" style="text-align:left" nowrap>Jaminan Hari Tua</td>
												<td width="1%" style="text-align:center" nowrap>JHT</td>
												<td width="3%" style="text-align:center" nowrap>-</td>
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
										  ...
										  <tr>
												...
												<td width="3%" style="text-align:left" nowrap>Jaminan Kecelakaan Kerja</td>
												<td width="1%" style="text-align:center" nowrap>JKK</td>
												<td width="3%" style="text-align:center" nowrap>-</td>
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
										  ...
										  <tr>
												...
												<td width="3%" style="text-align:left" nowrap>Jaminan Kematian</td>
												<td width="1%" style="text-align:center" nowrap>JKM</td>
												<td width="3%" style="text-align:center" nowrap>-</td>
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
										  ...
										  <tr>
												...
												<td width="3%" style="text-align:left" nowrap>BPJS Kesehatan</td>
												<td width="1%" style="text-align:center" nowrap>BPJ</td>
												<td width="3%" style="text-align:center" nowrap>-</td>
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
										  ...
										  <tr>
												<td width="1%" id="kt_table_1">9</td>
												<td width="3%" style="text-align:left" nowrap>Kasbon</td>
												<td width="1%" style="text-align:center" nowrap>KSK</td>
												<td width="3%" style="text-align:center" nowrap>-</td>
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
