        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    Data Penerima Gaji Pegawai Kontrak Harian
                </h3>
			<span class="kt-subheader__separator kt-subheader__separator--v"></span>
									<div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total" style="color:#ff0000">
											Periode 01/01/2023 - 07/01/2023 </span>
			...
			<a href="data-gaji-pegawai-harian.php" class="btn btn-label-brand btn-sm">
                ...
                <a href="penerima-gaji-tambahan-pegawai-harian-add.php" class="btn btn-info btn-sm">
											...
											<tr>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-gaji-pegawai-harian.php" class="kt-nav__link">
