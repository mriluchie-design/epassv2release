							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="peringatan-form.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i>  Buat Surat Peringatan</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
                                      ...
                                      <option value="12" >Pengembangan Usaha dan Kerjasama</option>
												...
												<div class="col-lg-1">
						                          ...
						                          <select class="form-control kt-selectpicker" data-live-search="true">
																							...
																							<option value="HI">Nama Cabang A</option>
											...
											<div class="kt-widget24">
												<div class="kt-widget24__details">
													<div class="kt-widget24__info">
														...
														<span class="kt-widget24__desc">
															Surat Peringatan yang Disetujui
														</span>
													</div>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="3%" bgcolor="#f7fcff">Nomor<br>Surat Peringatan</th>
												<th width="9%" bgcolor="#f7fcff">Tanggal<br>Surat Peringatan</th>
												<th width="9%" bgcolor="#f7fcff">Jenis<br>Peringatan</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center">002/SP/XII/2022</td>
										  ...
										  <tr>
												...
												<td style="text-align:center">001/SP/XII/2022</td>
												<td style="text-align:center">1 November 2019</td>
												<td style="text-align:center">Peringatan Pertama</td>
