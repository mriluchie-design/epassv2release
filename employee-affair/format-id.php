				...
				<form class="kt-form">
					<div class="kt-portlet__body">
                        <div class="form-group row">
							...
							<div class="col-lg-3">
						                          <label class="">Format Nomor :</label>
																			<div class="kt-input-icon kt-input-icon--right">
																 <input type="text" class="form-control form-control-sm" placeholder="Search..." id="generalSearch">
																 <span class="kt-input-icon__icon kt-input-icon__icon--right">
																							 <span><i class="la la-search"></i></span>
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="5%" rowspan="2" bgcolor="#f7fcff">Format Nomor</th>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH NOMOR</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
									...
									<div class="modal-content">
										...
										<div class="kt-portlet__body">
											<div class="tab-content">
												...
												<div class="col-lg-6">
														<label>Uraian :</label>
														<input type="text" class="form-control form-control-sm" placeholder="NIP PEGAWAI TETAP" disabled>
