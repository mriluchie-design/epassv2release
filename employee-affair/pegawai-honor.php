    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="pegawai-honor-add.php" class="btn btn-info btn-sm">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="6%" bgcolor="#f7fcff">Nama Pegawai</th>
											  <th width="6%" bgcolor="#f7fcff">Departemen</th>
											  <th width="6%" bgcolor="#f7fcff">Bagian</th>
											  <th width="6%" bgcolor="#f7fcff">Jabatan</th>
											 
											  <th width="3%" bgcolor="#f7fcff">Tanggal<br>Mulai Kerja</th>
											  <th width="3%" bgcolor="#f7fcff">Tanggal<br>Kontrak Berakhir</th>
											...
											<tr>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="pegawai-honor-detail.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="cetak-sk-honor.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-print"></i>
																				<span class="kt-nav__link-text">Cetak SK Honor</span>
																			</a>
																		</li>

																		<li class="kt-nav__item">
																			<a href="pegawai-honor-edit.php" class="kt-nav__link">
