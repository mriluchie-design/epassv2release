					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="40%" bgcolor="#f7fcff">Tingkat Pendidikan</th>
										...
										<tbody>
											<tr>
												<td width="1%">1</td>
												<td width="8%" align="left" valign="left" style="text-align:left">S3</td>
											...
											<tr>
												<td width="1%">2</td>
												<td width="8%" align="left" valign="left" style="text-align:left">S2</td>
										  ...
										  <tr>
												<td width="1%">3</td>
												<td width="8%" align="left" valign="left" style="text-align:left">S1</td>
										  ...
										  <tr>
												<td width="1%">4</td>
												<td width="8%" align="left" valign="left" style="text-align:left">SMA</td>
										  ...
										  <tr>
												<td width="1%">5</td>
												<td width="8%" align="left" valign="left" style="text-align:left">SMP</td>
										  ...
										  <tr>
												<td width="1%">6</td>
												<td width="8%" align="left" valign="left" style="text-align:left">SD</td>
										  ...
										  <tr>
												<td width="1%">7</td>
												<td width="8%" align="left" valign="left" style="text-align:left">TK</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH TINGKAT PENDIDIKAN</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
