...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
											  ...
											  <div class="col-lg-2">
						                          <label class="">No. SK Pegawai :</label>
												...
												<div class="col-lg-2">
						                          <label class="">No. Perjanjian :</label>
																			<div class="kt-input-icon kt-input-icon--right">
																 <input type="text" class="form-control form-control-sm" placeholder="Search..." id="generalSearch">
																 <span class="kt-input-icon__icon kt-input-icon__icon--right">
																							 <span><i class="la la-search"></i></span>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="12%" rowspan="2" bgcolor="#f7fcff">No. Kontrak <br>Pegawai</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Foto</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Nama Pegawai</th>
												<th width="9%" bgcolor="#f7fcff" rowspan="2">Departemen</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Divisi</th>
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Jabatan</th>
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Kantor</th>
												<th colspan="2" bgcolor="#f7fcff">Kontrak<br></th>
												<th width="1%" rowspan="2" bgcolor="#f7fcff">Verfikasi  Kontrak</th>
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Aksi</th>
												<tr style="text-align:center">
											  <th width="8%" bgcolor="#f7fcff">Awal</th>
											  <th width="8%" bgcolor="#f7fcff">Berakhir</th>
										  </tr>
											</tr>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left">004/KONTRAK-PEGAWAI/XII/2022</td>
												...
												<td width="1%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																		...
																		<li class="kt-nav__item">
																			<a href="edit-perjanjian-kontrak.php" class="kt-nav__link">
											...
											<tr>
												...
												<td style="text-align:left">003/KONTRAK-PEGAWAI/XII/2022</td>
										  ...
										  <tr>
												...
												<td style="text-align:left">002/KONTRAK-PEGAWAI/XII/2022</td>
										  ...
										  <tr>
												...
												<td style="text-align:left">001/KONTRAK-PEGAWAI/XII/2022</td>
