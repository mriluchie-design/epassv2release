					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="40%" bgcolor="#f7fcff">Hubungan Keluarga</th>
										...
										<tbody>
											<tr>
												<td width="1%">1</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Suami</td>
											...
											<tr>
												<td width="1%">2</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Istri</td>
										  ...
										  <tr>
												<td width="1%">3</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Anak</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH HUBUNGAN KELUARGA</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
