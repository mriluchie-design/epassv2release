							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="keterangan-penghasilan-form.php" class="btn btn-info btn-sm">
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2">No. Surat<br>Keterangan Penghasilan</th>
												<th width="1%" colspan="2" bgcolor="#f7fcff">Tanggal<br>												  <br></th>
												<th colspan="4" bgcolor="#f7fcff">Data Pegawai</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Periode</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Status</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Aksi</th>
											</tr>
											<tr>
											  <th width="4%" bgcolor="#f7fcff">Dibuat</th>
											  <th width="4%" bgcolor="#f7fcff">Terakhir<br>Dicetak</th>
											  <th width="3%" bgcolor="#f7fcff">Foto</th>
											  <th width="15%" bgcolor="#f7fcff">Nama Pegawai</th>
											  <th width="3%" bgcolor="#f7fcff">Kantor</th>
											  <th width="3%" bgcolor="#f7fcff">Status Pegawai</th>
										    </tr>
										</thead>
										<tbody>
											<tr>
												<td id="kt_table_1">1</td>
												<td id="kt_table_1">004/SKP/VIII/2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												...
												<td style="text-align:left" id="kt_table_1">Oklan Zulkifli, SE</td>
												...
												<td style="text-align:center">Januari 2020</td>
											  <td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon" data-toggle="modal" data-target="#modal_persetujuan_pending" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-penghasilan.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="hr-cetak-penghasilan.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-file-invoice"></i>
																				<span class="kt-nav__link-text">Cetak Keterangan Penghasilan</span>
																			</a>
																		</li>
											...
											<tr>
												...
												<td id="kt_table_1">003/SKP/VIII/2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												...
												<td style="text-align:left" id="kt_table_1">Deddy Rafsanjani, S.Sos</td>
										  ...
										  <tr>
												...
												<td id="kt_table_1">002/SKP/VIII/2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000005" data-html="true">
														<img src="../assets/media/users/100_6.jpg" alt="image">
													</a></td>
												<td style="text-align:left" id="kt_table_1">Akmal Baharuddin</td>
										  ...
										  <tr>
												...
												<td id="kt_table_1">001/SKP/VIII/2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												<td id="kt_table_1">13 Agustus 2023</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="000000000006" data-html="true">
														<img src="../assets/media/users/300_21.jpg" alt="image">
													</a></td>
												<td style="text-align:left" id="kt_table_1">Muhammad Ramadhan Lerrick, ST</td>
