											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														...
														<a href="hr-history-kepegawaian.php" class="kt-widget__item kt-widget__item--active ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="7" y="14" width="9" height="2" rx="1"/>
														...
														<a href="hr-data-keluarga.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
                    ...
                    <div class="kt-portlet__body">
                      <div class="row">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Kepegawaian</div>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
						...
						<div class="col-lg-2">
                          <label>Kantor :</label>
                        <select class="form-control kt-select2 form-control-sm" id="kt_select2_2_modal" name="param">
							...
							<div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="3%" bgcolor="#f7fcff">Tanggal Penetapan</th>
											  <th width="3%" bgcolor="#f7fcff">No. SK Penetapan</th>
											  <th bgcolor="#f7fcff">Jabatan<br />Baru</th>
											  <th bgcolor="#f7fcff">Department<br />Baru</th>
											  <th bgcolor="#f7fcff">Kantor<br />Baru</th>
										...
										<tbody>
											<tr>
												...
												<td width="3%" style="text-align:center" nowrap>29/SK-DIR-IM/X/2019</td>
												<td width="5%" style="text-align:center" nowrap>Project Administrasi</td>
											...
											<tr>
												...
												<td width="3%" style="text-align:center" nowrap>32/SK-DIR-IM/X/2019</td>
												<td width="5%" style="text-align:center" nowrap>Staff Administrasi</td>
														<td width="3%" style="text-align:center" nowrap>HR &amp; GA</td>
