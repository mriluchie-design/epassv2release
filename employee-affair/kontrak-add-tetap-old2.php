              ...
              <div class="col-lg-12">
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Surat</div><br><br>
										 <div class="kt-portlet__body">
...
<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
                      ...
                      <div class="form-group row">
                       <div id="kt_repeater_2">
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Menetapkan</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-12">
                      ...
                      <div class="form-group row">
                       <div class="col-lg-6">
                          <label>Nama Pegawai Kontrak :</label>
...
<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
  ...
  <tr>
    ...
    <td width="331" rowspan="3" valign="right"><img src="../assets/img/paraf.png" width="50" height="50" /></td>
