...
function goBack() {
  window.history.back();
											...
											<div class="kt-widget kt-widget--user-profile-1">
												<div class="form-group row" style="text-align:center">
														...
														<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
																			<div class="kt-avatar__holder" style="background-image: url(&quot;../assets/img/users/100_15.jpg&quot;);"></div>
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														<a href="calon-pegawai-detail.php" class="kt-widget__item">
														...
														<a href="calon-pegawai-kepegawaian.php" class="kt-widget__item kt-widget__item">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
        ...
        <path d="M5,2 L17,2 C18.6568542,2 20,3.34314575 20,5 L20,19 C20,20.6568542 18.6568542,22 17,22 L5,22 C4.44771525,22 4,21.5522847 4,21 L4,3 C4,2.44771525 4.44771525,2 5,2 Z M12,11 C13.1045695,11 14,10.1045695 14,9 C14,7.8954305 13.1045695,7 12,7 C10.8954305,7 10,7.8954305 10,9 C10,10.1045695 10.8954305,11 12,11 Z M7.00036205,16.4995035 C6.98863236,16.6619875 7.26484009,17 7.4041679,17 C11.463736,17 14.5228466,17 16.5815,17 C16.9988413,17 17.0053266,16.6221713 16.9988413,16.5 C16.8360465,13.4332455 14.6506758,12 11.9907452,12 C9.36772908,12 7.21569918,13.5165724 7.00036205,16.4995035 Z" id="Combined-Shape" fill="#000000"></path>
														...
														<a href="calon-pegawai-karir.php" class="kt-widget__item kt-widget__item--active">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="calon-pegawai-keluarga.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="calon-pegawai-pendidikan.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="calon-pegawai-sertifikat.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="calon-pegawai-pengalaman.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        ...
                                                        <a href="calon-pegawai-login.php" class="kt-widget__item">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="3%" bgcolor="#f7fcff">Tanggal SK Kontrak</th>
											  <th width="3%" bgcolor="#f7fcff">No. SK Kontrak</th>
										...
										<tbody>
										  ...
										  <tr>
												...
												<td style="text-align:left" nowrap>29 Oktober 2020</td>
												<td style="text-align:left" nowrap>30/SK-DIR-IM/X/2020</td>
												<td style="text-align:left" nowrap>Umum</td>
												<td style="text-align:left" nowrap>Humas</td>
												<td style="text-align:left" nowrap>Staff Administrasi Humas</td>
												<td style="text-align:left" nowrap>Pusat</td>
												<td style="text-align:center"><span class="kt-badge kt-badge--warning kt-badge--md kt-badge--inline">Calon Pegawai</span></td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Download SK Calon Pegawai"> <i class="fa flaticon-download-1"></i> </span></td>

										  </tr>
										  <tr>
												<td style="text-align:right"  id="kt_table_1">2</td>
												<td style="text-align:left" nowrap>25 Oktober 2019</td>
												<td style="text-align:left" nowrap>29/SK-DIR-IM/X/2019</td>
												<td style="text-align:left" nowrap>Umum</td>
												<td style="text-align:left" nowrap>Humas</td>
												<td style="text-align:left" nowrap>Staff Administrasi Humas</td>
												<td style="text-align:left" nowrap>Pusat</td>
												<td style="text-align:center"><span class="kt-badge kt-badge--info kt-badge--md kt-badge--inline">Kontrak</span></td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Download SK Kontrak"> <i class="fa flaticon-download-1"></i> </span></td>
							...
							<div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="5%" rowspan="2" bgcolor="#f7fcff">Tanggal Surat Teguran</th>
											  <th width="7%" rowspan="2" bgcolor="#f7fcff">No. Surat Teguran</th>
											  <th width="3%" rowspan="2" bgcolor="#f7fcff">Tipe Teguran</th>
											  <th width="3%" colspan="2" bgcolor="#f7fcff">Masa Berlaku Teguran</th>
											  <th width="3%" rowspan="2" bgcolor="#f7fcff">Kantor<br /></th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>

										  </tr>
											<tr style="text-align:center">
											  <th width="3%" bgcolor="#f7fcff">Awal</th>
											  <th width="3%" bgcolor="#f7fcff">Akhir</th>
									      </tr>
										</thead>
										<tbody>
											<tr>
												<td style="text-align:center"  id="kt_table_1">1</td>
												<td style="text-align:center" nowrap>29 Oktober 2019</td>
												<td style="text-align:center" nowrap>002/ST/XII/2022</td>
												<td style="text-align:center" nowrap>Peringatan II</td>
												<td style="text-align:center" nowrap>01 Desember 2022</td>
												<td style="text-align:center" nowrap>31 Desember 2022</td>
												<td style="text-align:center" nowrap>Nama Cabang</td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Download Surat"> <i class="fa flaticon-download-1"></i> </span></td>

										  </tr>
											<tr>
												<td style="text-align:center"  id="kt_table_1">2</td>
												<td style="text-align:center" nowrap>25 Oktober 2019</td>
												<td style="text-align:center" nowrap>001/ST/XII/2022</td>
												<td style="text-align:center" nowrap>Peringatan I</td>
												<td style="text-align:center" nowrap>01 Desember 2022</td>
												<td style="text-align:center" nowrap>31 Desember 2022</td>
