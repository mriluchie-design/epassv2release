	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
			<div class="dropdown dropdown-inline" ddata-placement="left">
				<a href="pegawai-kontrak-harian.php" class="btn btn-label-brand btn-sm">
											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														<a href="pegawai-kontrak-harian-add.php" class="kt-widget__item kt-widget__item--active">
														...
														<a href="add-data-kepegawaian-kontrak-harian.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="add-data-keluarga-pegawai-kontrak-harian.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="add-data-pendidikan-pegawai-kontrak-harian.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="add-data-sertifikat-pegawai-kontrak-harian.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="add-data-pengalaman-pegawai-kontrak-harian.php" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        ...
                                                        <a href="add-data-loginapp-kontrak-harian.php" class="kt-widget__item">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
                    <div class="kt-portlet__body">
                     ...
                     <div class="form-group row">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="Fira"  >
                      </div>
                        </div>
						<div class="col-lg-3">
                          <label>Jenis Kelamin :</label>
                         <input type="text" class="form-control form-control-sm"  placeholder="Wanita">
                        </div>
						<div class="col-lg-3">
                          <label>Status :</label>
                         <input type="text" class="form-control form-control-sm"  placeholder="Single">
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
                     <div class="form-group row">
...
<div class="col-lg-6">
					                           ...
					                           <input type="text" class="form-control form-control-sm" placeholder="Makassar">
					                         </div>
						<div class="col-lg-6">
                          <label class="">Tanggal Kelahiran :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="18 November 1993">
                     ...
                     <div class="form-group row">
						...
						<div class="col-lg-6">
					                           <label>Agama :</label>
                        <input type="text" class="form-control form-control-sm" placeholder="Islam">
					                         </div>
						<div class="col-lg-6">
...
<div class="form-group row">
						...
						<div class="col-lg-3">
                          ...
                          <input type="text" class="form-control form-control-sm" placeholder="Mandiri">
                      </div>
						<div class="col-lg-6">
