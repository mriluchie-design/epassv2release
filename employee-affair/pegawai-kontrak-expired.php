...
<td style="text-align:center" nowrap><button type="button" class="btn btn-label-success btn-sm">Tetap</button></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="pegawai-kontrak-expired-detail.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="cetak-id-card-pegawai-kontrak-expired.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="pegawai-kontrak-expired-perpanjangan.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-user-clock"></i>
																				<span class="kt-nav__link-text">Perpanjang Kontrak Pegawai</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="pegawai-kontrak-expired-edit.php" class="kt-nav__link">
											...
											<tr>
												...
												<td width="3%" style="text-align:left" nowrap>Oklan Zulkifli, SE</td>
												<td style="text-align:left" nowrap>Umum</td>
											...
											<tr>
												...
												<td width="3%" style="text-align:left" nowrap>Deddy Rafsanjani, S.Sos</td>
											...
											<tr>
												...
												<td width="3%" style="text-align:left" nowrap>Akmal Baharuddin</td>
												<td style="text-align:left" nowrap>Keuangan dan Asset</td>
											...
											<tr>
												...
												<td width="3%" style="text-align:left" nowrap>Nursiah, S.Kom</td>
											...
											<tr>
												...
												<td width="3%" style="text-align:left" nowrap>Muhammad Ramadhan Lerrick, ST</td>
												<td style="text-align:left" nowrap>Operasional</td>
