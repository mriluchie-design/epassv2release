...
<?php require './layouts/header.php' ?>
      ...
      <!-- begin:: Content Head -->
        ...
        <path d="M5,2 L17,2 C18.6568542,2 20,3.34314575 20,5 L20,19 C20,20.6568542 18.6568542,22 17,22 L5,22 C4.44771525,22 4,21.5522847 4,21 L4,3 C4,2.44771525 4.44771525,2 5,2 Z M12,11 C13.1045695,11 14,10.1045695 14,9 C14,7.8954305 13.1045695,7 12,7 C10.8954305,7 10,7.8954305 10,9 C10,10.1045695 10.8954305,11 12,11 Z M7.00036205,16.4995035 C6.98863236,16.6619875 7.26484009,17 7.4041679,17 C11.463736,17 14.5228466,17 16.5815,17 C16.9988413,17 17.0053266,16.6221713 16.9988413,16.5 C16.8360465,13.4332455 14.6506758,12 11.9907452,12 C9.36772908,12 7.21569918,13.5165724 7.00036205,16.4995035 Z" id="Combined-Shape" fill="#000000"></path>
														...
														<a href="pegawai-kontrak-sertifikat.php" class="kt-widget__item kt-widget__item--active ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  <th width="3%" bgcolor="#f7fcff" id="kt_table_2">#</th>
											  <th width="35%" bgcolor="#f7fcff">Nama Sertifikat</th>
											  <th width="35%" bgcolor="#f7fcff">Sertifikat Dikeluarkan Oleh</th>
											  <th width="35%" bgcolor="#f7fcff">Lokasi</th>
											  <th width="20%" bgcolor="#f7fcff">Tahun<br>Sertifikat</th>
											  <th width="9%" bgcolor="#f7fcff">Aksi</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left" nowrap>Microsoft Most Valuable Professional</td>
												<td style="text-align:center" nowrap>Microsoft</td>
												<td style="text-align:left" nowrap>Jakarta</td>
												<td style="text-align:center" nowrap>2007</td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Download Setifikat"> <i class="fa flaticon-download-1"></i> </span></td>
										  </tr>
