					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="40%" bgcolor="#f7fcff">Jenis Pensiun</th>
										...
										<tbody>
											<tr>
												<td width="1%">1</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pensiun Normal</td>
											...
											<tr>
												<td width="1%">2</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pensiun Tidak Cakap Jasmani/Rohani </td>
										  ...
										  <tr>
												<td width="1%">3</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pensiun Atas Permintaan Sendiri </td>
										  ...
										  <tr>
												<td width="1%">4</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pensiun Janda Duda Meninggal Dunia Aktif</td>
										  ...
										  <tr>
												<td width="1%">5</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pensiun Anumerta</td>
										  ...
										  <tr>
												<td width="1%">6</td>
												<td width="8%" align="left" valign="left" style="text-align:left">Pensiun Karena Mencalonkan Diri </td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH JENIS PENSIUN</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
