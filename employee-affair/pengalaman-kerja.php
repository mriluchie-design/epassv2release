									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="5%" bgcolor="#f7fcff">No. Surat <br>Pengalaman Kerja</th>
												<th width="8%" bgcolor="#f7fcff">Tanggal Surat Pengunduran Diri</th>
												<th width="8%" bgcolor="#f7fcff">Tanggal Resign <br>Pegawai</th>
												<th width="22%" bgcolor="#f7fcff">Keterangan</th>
