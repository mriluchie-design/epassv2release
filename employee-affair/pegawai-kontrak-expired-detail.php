							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Profil Pegawai Kontrak Expired
									</h3>

								</div>
								<div class="kt-subheader__toolbar">
									<div class="dropdown dropdown-inline" ddata-placement="left">
											<a href="pegawai-kontrak-expired.php" class="btn btn-label-brand btn-sm" data-toggle="dropdown" onclick="goBack()">
											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														<a href="pegawai-kontrak-detail.php" class="kt-widget__item kt-widget__item--active">
...
<div class="col-xl-4">
                       ...
                       <div class="col-lg-12">
						...
						<div class="col-lg-6">
                          ...
                          <div class="form-group">
                        <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Nama Provinsi">
                      </div>
                        </div>
