							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="hr-request-surat-keterangan-kerja.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i>Buat Surat Keterangan Kerja</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2">ID Permohonan</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Waktu<br>Permohonan</th>
												<th width="3%" colspan="4" bgcolor="#f7fcff">Data Pemohon</th>
												<th width="1%" bgcolor="#f7fcff" rowspan="2">No. Surat<br>Keterangan Bekerja</th>
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Tujuan Permohonan</th>
												<th width="1%" rowspan="2" bgcolor="#f7fcff">Dibuat<br />
												  Oleh</th>
											...
											<tr>
											  ...
											  <th width="1%" bgcolor="#f7fcff">Status<br>Pegawai</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="000000000001<hr>Direksi<hr>Direksi<hr>Direktur Utama" data-html="true">
												...
												<td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Sri Suhartini, SE&lt;hr&gt;Kepala Seksi Administrasi Kepegawaian" data-html="true"> <img src="../assets/media/users/100_16.jpg" alt="image" /> </a></td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="hr-detail-permohonan-surat-keterangan-bekerja.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="print-surat-keterangan-bekerja.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td id="kt_table_1">002/SKK/XII/2022</td>
												<td style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
												<td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="000000000001<hr>Direksi<hr>Direksi<hr>Direktur Utama" data-html="true">
														<img src="../assets/media/users/100_15.jpg" alt="image">
													</a></td>
