				...
				<!--end::Nav-->
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-3">
								<div class="bg-white w-50 ml-auto mr-auto">
									...
									<table class="table-checkable" cellpadding="3" align="left" width="650" style="line-height:1.5; margin-left:63px; position:relative;top:70px; font-family: Tahoma; font-size: 12px;">
										<tbody>
											<tr>
												<td colspan="3">
													<div align="center">
...
<div style="width:650px; margin-left:auto; position:relative; top:100px; font-size: 12px; margin-right:auto">
									<div class="row">
										<div class="col-lg-6">
											...
											<table class="upah w-100 mt-5">
												...
												<tbody>
													<tr>
														...
														<td width="1">:</td>
														<td width="39" style="text-align:right;"><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>2.941.270,-</span> </div></td>
													</tr>
													<tr>
														<td>Tunj. Jabatan</td>
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>75.000,-</span> </div></td>
													</tr>
													<tr>
														<td>Tunj. Keluarga</td>
														<td>:</td>
													...
													<tr>
														...
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>520.000,-</span> </div></td>
													</tr>
													<tr>
														<td>Tunj. Kinerja</td>
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>250.000,-</span> </div></td>
													</tr>
													<tr>
														<td>THR</td>
														<td>:</td>
													...
													<tr>
														...
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>127.663,-</span> </div></td>
													</tr>
													<tr>
														<td>JHT 3,7%</td>
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>108.827,-</span> </div></td>
													</tr>
													<tr>
														<td>JKK & JKM</td>
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>15.883,-</span> </div></td>
													</tr>
													<tr>
														<td colspan="3"></td>
													</tr>
												...
												<tfoot>
														...
														<tr style="border-top:2px solid #000;border-bottom:2px solid #000;background:#ffffcc">
															...
															<th>:</th>
															<th><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>4.138.643,-</span> </div></th>
														</tr>
														<tr style="border-bottom:1px solid #000">
															<th colspan="3" style="padding:0.1rem"></th>
														</tr>
														<tr style="border-top:2px solid #000;border-bottom:2px solid #000;background:#ccecff">
															...
															<th>:</th>
															<th><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>3.695.529,-</span> </div></th>
														</tr>
														<tr style="border-bottom:1px solid #000">
															<th colspan="3" style="padding:0.1rem"></th>
														</tr>
											...
											<table class="upah w-100 mt-5">
												...
												<tbody>
													<tr>
														...
														<td width="1">:</td>
														<td width="39"><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>0,-</span> </div></td>
													</tr>
													<tr>
														<td>Absensi</td>
														<td>:</td>
													...
													<tr>
														...
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>31.916,-</span> </div></td>
													</tr>
													<tr>
														<td>JHT 3,7% ded</td>
														<td>:</td>
													...
													<tr>
														<td>JHT 2%</td>
														<td>:</td>
														<td><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>58.825,-</span> </div></td>
													</tr>
													<tr>
													...
													<tr>
														<td colspan="3" style="padding-top:5.5rem"></td>
													</tr>
												</tbody>
												<tfoot>
														
														<tr style="border-top:2px solid #000;border-bottom:2px solid #000;background:#ffffcc">
															<th style="text-align:left">Total Potongan</th>
															<th>:</th>
															<th><div style="display: flex; justify-content: space-between; align-items: center;"> <span>Rp.</span> <span>443.114,-</span> </div></th>
														</tr>
														<tr style="border-bottom:1px solid #000">
															<th colspan="3" style="padding:0.1rem"></th>
														</tr>
									...
									<table class="table table-bordered mt-3 text-center" style="position:relative;top:70px;">
										<thead>
										<tr>
