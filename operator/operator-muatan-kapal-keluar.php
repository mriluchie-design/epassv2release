            ...
            <!-- end:: Alert -->
				...
				<div class="kt-portlet__body">
					  ...
					  <div class="col-lg-4">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Kendaraan Muatan Kapal</div><br><br>
										 <div class="kt-portlet__body">
					  ...
					  <div class="col-lg-2">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--brand">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Foto Job Delivery</div><br><br>
										 <div class="kt-portlet__body">
