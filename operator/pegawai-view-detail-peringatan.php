...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
              ...
              <div class="col-lg-12">
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Surat Peringatan</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-12">
                          <label>Nomor Surat Peringatan :</label>
						  <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="001/SP/XI/2022">
						...
						<div class="col-lg-12">
                         ...
                         <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Peringatan II">
                        </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
						...
						<div class="col-lg-6">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="14 Juli 2025">
                        </div>
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Penerima</div>
							<br>
							<br>
										<div class="kt-portlet__body">
						...
						<div class="col-lg-6">
                          <label>Kantor :</label>
						   <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Pusat" />
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Dasar</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-12">
						  ...
						  <div id="kt_repeater_3">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Isi Pelanggaran</div><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-12">
                          <label></label>
                      ...
                      <div class="form-group row">
                       <div id="kt_repeater_2">
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_3">
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">1</td>
																									<td style="text-align:left"><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Direktur Utama" />
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">2</td>
																									<td style="text-align:left"><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Direktur Umum" />
						...
						<table align="center" border="0" cellpadding="1" style="width: 600px; position:relative; top:100px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 13px;">
							<tr>
								<th colspan="11" class="text-center"><span style="font-family: Roboto; font-size: 13px;"><u>SURAT PERINGATAN II</b></u></span><br /><span style="font-family: Roboto; font-size: 13px; margin-bottom:3rem">
														<b>Nomor : 088/SP/XII/2022</b></span>
							  </th>
							</tr>
							<tr>
							  <td colspan="11">&nbsp;</td>
							...
							<tr>
							  ...
							  <td width="401" colspan="4" valign="top">Deddy Rafsanjani, S.Sos</td>
  </tr>
							<tr>
							  <td valign="top">&nbsp;</td>
							  <td width="3" valign="top">&nbsp;</td>
							  ...
							  <td valign="top">:</td>
							  <td colspan="4" valign="top">000000000003</td>
  </tr>
							<tr>
							  <td valign="top">&nbsp;</td>
							  <td width="3" valign="top">&nbsp;</td>
							...
							<tr>
							  ...
							  <td valign="top">:</td>
							  <td colspan="4" valign="top">Staff Administrasi Kepegawaian</td>
  </tr>
							<tr>
							  <td colspan="11" valign="top">&nbsp;</td>
  </tr>
							...
							<tr>
							  <td colspan="11" valign="top"><p>Demikian Surat Peringatan ini dibuat untuk diketahui dan sekaligus menjadi bahan  pertimbangan Direksi <strong>[Nama-Perusahaan]</strong> dalam pengambilan keputusan selanjutnya.<br />
						      </p></td>
  </tr>
							<tr>
							  <td valign="top">&nbsp;</td>
  ...
  <table align="center" border="0" cellpadding="1" style="width: 600px; position:relative; top:100px; margin-top:100px; margin-bottom:-100px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 13px;">
							<tr>
							  <td width="3" valign="top">&nbsp;</td>
							  <td width="3" valign="top">&nbsp;</td>
							  <td width="3" valign="top">&nbsp;</td>
							...
							<tr>
							  ...
							  <td valign="top">&nbsp;</td>
							  <td valign="top">1.</td>
							  <td colspan="4" valign="top">Direktur Utama</td>
							  <td valign="top">&nbsp;</td>
							  <td valign="top">&nbsp;</td>
							...
							<tr>
							  ...
							  <td valign="top">&nbsp;</td>
							  <td valign="top">2.</td>
							  <td colspan="4" valign="top">Direktur Umum</td>
							  <td valign="top">&nbsp;</td>
							  <td valign="top">&nbsp;</td>
							  <td valign="top">&nbsp;</td>
  </tr>
							<tr>
							  ...
							  <td valign="top">&nbsp;</td>
							  <td valign="top">3.</td>
							  <td colspan="4" valign="top">Arsip</td>
							  <td valign="top">&nbsp;</td>
							  <td valign="top">&nbsp;</td>
