				...
				<div class="kt-portlet__body">
                      ...
                      <div class="form-group row">
						<div class="col-lg-12" >
                          ...
                          <div class="kt-input-icon kt-input-icon--right">
        							<input type="text" class="form-control form-control-sm" placeholder="Scan Kartu Disini..." id="generalSearch">
                      ...
                      <div class="form-group row" style="text-align:center">
														...
														<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
																			<div class="kt-avatar__holder" style="width:200px; height:200px; background-image: url(&quot;../assets/media/users/qrcode.png&quot;);"></div>
                      ...
                      <div class="form-group row">
						...
						<div class="col-lg-2">
                          <label class="">IP Reader Payment :</label>
