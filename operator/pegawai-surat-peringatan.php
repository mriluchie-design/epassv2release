...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
        							...
        							<span class="kt-input-icon__icon kt-input-icon__icon--right">
    		                            <span><i class="la la-search"></i></span>
												...
												<div class="col-lg-2">
						                          <label class="">Tanggal Surat Peringatan :</label>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center">001/SP-PEGAWAI/XII/2019</td>
											  ...
											  <td style="text-align:center" nowrap><button type="button" class="btn btn-success btn-sm btn-icon" data-toggle="modal" data-target="#modal_persetujuan_release" data-skin="brand" title="Disetujui" data-html="true"><i class="fa flaticon2-check-mark"></i></button></td>
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="pegawai-view-detail-peringatan.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="pegawai-cetak-peringatan.php" class="kt-nav__link">
											...
											<tr>
												...
												<td style="text-align:center">002/SP-PEGAWAI/XII/2020</td>
