...
function goBack() {
  window.history.back();
                     ...
                     <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Izin Terlambat Datang">
						...
						<div class="col-lg-3">
                          <label class="">Jam Izin:</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="12:14 WITA">
                        </div>
                        <div class="col-lg-3">
                          <label class="">Keterangan :</label>
                          <textarea class="form-control" disabled="disabled" placeholder="Antar Anak Sekolah" id="exampleTextarea" rows="4"></textarea>
                        </div>
                      </div>
					   <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
                      <div class="form-group row">
											...
											<div class="kt-timeline-v2">
												<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
													<div class="kt-timeline-v2__item">
														<span class="kt-timeline-v2__item-time">16/12/2022</span>
													...
													<div class="kt-timeline-v2__item">
														<span class="kt-timeline-v2__item-time">15/12/2022</span>
														<div class="kt-timeline-v2__item-cricle">
