									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="8%" rowspan="2" bgcolor="#f7fcff">No Dokumen</th>
<th width="8%" rowspan="2" bgcolor="#f7fcff">Kategori<br>SOP</th>
												<th width="30%" rowspan="2" bgcolor="#f7fcff">Perihal</th>
												<th width="2%" colspan="2" bgcolor="#f7fcff">Dibuat</th>
											...
											<tr>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="hr-view-sop.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="pegawai-download-sop.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-file-download"></i>
																				<span class="kt-nav__link-text">Download Peraturan</span>
																			</a>
																		</li>
<li class="kt-nav__item">
																			<a href="history-perubahan-sop.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa flaticon-share"></i>
																				<span class="kt-nav__link-text">History Perubahan</span>
																			</a>
																		</li>
