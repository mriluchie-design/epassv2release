...
<div class="col-lg-6">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Instalasi</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
...
<div class="col-lg-3">
                          <label class="">Total Jalur :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="6" disabled>
                        </div>
						<div class="col-lg-3">
                          <label class="">Tanggal Mulai :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="01 September 2026" disabled>
                        </div>
						<div class="col-lg-3">
                          <label class="">Deadline :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="08 September 2026" disabled>
                        </div>
                        </div>
<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
<div class="form-group row">
<div class="col-lg-3">
                          <label class="">Masuk Mobil :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="2" disabled>
                        </div>
<div class="col-lg-3">
                          <label class="">Keluar Mobil :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="2" disabled>
                        </div>
<div class="col-lg-3">
                          <label class="">Masuk Motor :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="2" disabled>
                        </div>
<div class="col-lg-3">
                          <label class="">Keluar Motor :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="0" disabled>
                        </div>
                        </div>
		...
		<div class="kt-portlet__head" style="background-color:#0e62ae ;">
			<div class="kt-portlet__head-label">
				<h3 class="kt-portlet__head-title">
					<span class="kt-font-light">GATE - 1</span>
				</h3>
			</div>
		</div>
		<div class="kt-portlet__body">
			<div class="row">
				...
				<div class="col-xl-12" style="height:500px; overflow-y:scroll;">
						...
						<div class="card">
							<div class="card-header" id="headingOne">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="false" aria-controls="collapseOne1">
									<span class="btn btn-twitter btn-sm">MASUK - MOBIL - 1</span>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-xl-12">
											<!--begin::Portlet-->
											<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
												<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Dispenser Single</div><br><br>
												<div class="kt-portlet__body">
													...
													<table class="table table-bordered table-hover table-checkable" id="kt_repeater_2">
																								...
																								<tr style="text-align:center">
																								  ...
																								  <td colspan="2" bgcolor="#f7fcff"><p>Material</p></td>
																									<td colspan="2" bgcolor="#f7fcff">INSTALASI</td>
																									<td colspan="2" bgcolor="#f7fcff">QC</td>
																									<td width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</td>
																								  </tr>
																								<tr style="text-align:center">
																								  <td width="1%" bgcolor="#f7fcff">QR Code</td>
																								  <td width="12%" bgcolor="#f7fcff">Nama</td>
																								  <td width="8%" bgcolor="#f7fcff">Scan</td>
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:right" bgcolor="#feffed">1</td>
																								  <td colspan="7" style="text-align:left" bgcolor="#feffed">DISPENSER</td>
																								  </tr>
																								<tr data-repeater-item>
																								  <td style="text-align:right">1.1</td>
																								  <td style="text-align:left">0001DSCILU150626</td>
																									<td style="text-align:left">CUSTOM CASING</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
      <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch">
      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span> </span> </div></td>
    <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
    <td style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
      <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch8" />
      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
    <td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																	...
																	<li class="kt-nav__item">
																			...
																			<a href="detail-perangkat.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Detail Perangkat</span>
																			</a>
																		</li>
																	<li class="kt-nav__item">

																			<a href="ubah-qrcode.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-edit"></i>
																				<span class="kt-nav__link-text">Ubah QR Code</span>
																			</a>
																		</li>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0002NFCILU150626</td>
																								  <td style="text-align:left">NFC PAYMENT READER</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch2" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch9" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								 <td style="text-align:center" nowrap=""><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																			...
																			<a href="ubah-qrcode.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Ubah QR Code</span>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0003PTTILU150626</td>
																								  <td style="text-align:left">PRINTER THERMAL</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch3" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch10" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td style="text-align:center" nowrap=""><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																			...
																			<a href="ubah-qrcode.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Ubah QR Code</span>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0004DLDILU150626</td>
																								  <td style="text-align:left">DISPLAY LAYAR</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch4" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch11" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
																								    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																								      <ul class="kt-nav">
																								        <li class="kt-nav__item"> <a href="detail-perangkat.php" class="kt-nav__link"> <i class="kt-nav__link-icon fa fa-eye"></i> <span class="kt-nav__link-text">Detail Perangkat</span> </a> </li>
																								        <li class="kt-nav__item"> <a href="ubah-qrcode.php" class="kt-nav__link"> <i class="kt-nav__link-icon fa fa-edit"></i> <span class="kt-nav__link-text">Ubah QR Code</span> </a> </li>
																							          </ul>
																							        </div>
																								    </div></td>
																								  </tr>
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0005DPCILU150626</td>
																								  <td style="text-align:left">DISPENSER PC</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch6" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch12" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
																								    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0006HUMILU150626</td>
																								  <td style="text-align:left">HUB SWITCH 8 PORT MANAGEABLE CLOUD</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch5" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch13" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
																								    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0007VLDILU150626</td>
																								  <td style="text-align:left">VEHICLE LOOP DETECTOR</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch7" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch14" />
																							      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								  <td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
																								    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0010CTDILU150626</td>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0009SPDILU150626</td>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0010UPSILU150626</td>
																								...
																								<tr data-repeater-item="data-repeater-item">
																								  <td style="text-align:right" bgcolor="#feffed">2</td>
																								  <td colspan="7" style="text-align:left" bgcolor="#feffed">BARRIER GATE</td>
																								  </tr>
																								<tr data-repeater-item>
																								  <td style="text-align:right">2.1</td>
																								  <td style="text-align:left">0011BGSILU150626</td>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0012VLDILU150626</td>
																								  <td style="text-align:left">VEHICLE LOOP DETECTOR</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch" />
																								    <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								...
																								<tr data-repeater-item="data-repeater-item">
																								  <td style="text-align:right" bgcolor="#feffed">3</td>
																								  <td colspan="7" style="text-align:left" bgcolor="#feffed">TIANG DAN SENSOR</td>
																								  </tr>
																								<tr data-repeater-item>
																								  <td style="text-align:right">3.1</td>
																								  <td style="text-align:left">0013ULRILU150626</td>
																								  <td style="text-align:left">UHF READER LONG RANGE</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch" />
																								    <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0014ICPILU150626</td>
																								  <td style="text-align:left">IP CAMERA PLAT</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch" />
																								    <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0015IPCILU150626</td>
																								...
																								<tr data-repeater-item>
																								  ...
																								  <td style="text-align:left">0016ITSRLU150626</td>
																								  <td style="text-align:left">TIANG SENSOR</td>
																								  <td><div class="kt-input-icon kt-input-icon--right">
																								    <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Barang" id="generalSearch" />
																								    <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div></td>
																								  <td><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="15 September 2026<hr>09:03:00 WITA<hr>12321355123123211<hr>Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
						...
						<div class="card">
							<div class="card-header" id="headingTwo">
								<div class="card-title d-grid collapsed" data-toggle="collapse" data-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1">
									<span class="btn btn-twitter btn-sm">MASUK - MOBIL - 2</span> </div>
							</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-xl-12">
											<!--begin::Portlet-->
											<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
												<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Dispenser Double</div><br><br>
												<div class="kt-portlet__body">
													<div class="kt-portlet__content">
													<table class="table table-bordered table-hover table-checkable" id="kt_repeater_2">
																								<thead>
						...
						<div class="card">
							<div class="card-header" id="headingThree1">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1">
									<span class="btn btn-twitter btn-sm">MASUK - MOTOR - 1</span>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-header" id="heading9">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapse9" aria-expanded="false" aria-controls="collapseThree1">
									<span class="btn btn-twitter btn-sm">MASUK - MOTOR - 2</span>
...
<div class="card">
							<div class="card-header" id="heading10">
								<div class="card-title d-grid collapsed" data-toggle="collapse" data-target="#collapse10" aria-expanded="false" aria-controls="collapseTwo1">
									<span class="btn btn-label-warning btn-sm">KELUAR - MOBIL - 1</span> </div>
							</div>
							<div id="collapse10" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionExample1">
								<div class="card-body">
									<div class="row">
										<div class="col-xl-12">
											<!--begin::Portlet-->
...
<div class="card">
							<div class="card-header" id="heading11">
								<div class="card-title d-grid collapsed" data-toggle="collapse" data-target="#collapse11" aria-expanded="false" aria-controls="collapseTwo1">
									<span class="btn btn-label-warning btn-sm">KELUAR - MOBIL - 2</span> </div>
							</div>
							<div id="collapse11" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionExample1">
								<div class="card-body">
									<div class="row">
										<div class="col-xl-12">
											<!--begin::Portlet-->
...
<div class="col-lg-3">
                          <label class="">Total Jalur :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="8" disabled>
                        </div>
						<div class="col-lg-3">
                          <label class="">Tanggal Mulai :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="01 September 2026" disabled>
...
<div class="col-lg-3">
		...
		<div class="kt-portlet__head" style="background-color:#0e62ae ;">
			<div class="kt-portlet__head-label">
				<h3 class="kt-portlet__head-title">
					<span class="kt-font-light">GATE - 2</span>
				</h3>
			</div>
		</div>
		<div class="kt-portlet__body">
			<div class="row">
				...
				<div class="col-xl-12" style="height:650px; overflow-y:scroll;">
					<div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample1">
						<div class="card">
							<div class="card-header" id="headingOne">
								<div class="card-title collapsed d-grid" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="false" aria-controls="collapseOne1">
...
<div class="card">
							<div class="card-header" id="heading12">
								<div class="card-title d-grid collapsed" data-toggle="collapse" data-target="#collapse12" aria-expanded="false" aria-controls="collapseTwo1">
									<span class="btn btn-label-warning btn-sm">KELUAR - MOTOR - 1</span> </div>
							</div>
							<div id="collapse12" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionExample1">
								<div class="card-body">
									<div class="row">
										<div class="col-xl-12">
											<!--begin::Portlet-->
...
<div class="card">
							<div class="card-header" id="heading13">
								<div class="card-title d-grid collapsed" data-toggle="collapse" data-target="#collapse13" aria-expanded="false" aria-controls="collapseTwo1">
									<span class="btn btn-label-warning btn-sm">KELUAR - MOTOR - 2</span> </div>
							</div>
							<div id="collapse13" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionExample1">
								<div class="card-body">
									<div class="row">
										<div class="col-xl-12">
											<!--begin::Portlet-->
    ...
    <td style="text-align:center" nowrap=""><div class="kt-widget2__actions">
								...
								<div class="row">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Hasil Perjalanan Dinas</div><br>
							<br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
                        ...
                        <div id="kt_repeater_6">
												<table class="table table-bordered table-hover table-checkable" id="kt_repeater_6">
																								...
																								<tr style="text-align:center">
																								  ...
																								  <td width="6%" bgcolor="#f7fcff">Tanggal</td>
																									<td width="15%" bgcolor="#f7fcff">Uraian Kegiatan</td>
																									<td width="8%" bgcolor="#f7fcff">Upload Foto</td>
																									<td width="8%" bgcolor="#f7fcff">Upload Laporan Harian</td>
                                                ...
                                                <tbody data-repeater-list="">
							                        ...
							                        <input type="text" class="form-control form-control-sm kt_datepicker_2_modal" readonly="" placeholder="">
