					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="18%" bgcolor="#f7fcff">Nama Modul</th>
											  <th width="18%" bgcolor="#f7fcff">Sub Modul</th>
											  <th width="18%" bgcolor="#f7fcff">Nama Menu</th>
											  <th width="20%" bgcolor="#f7fcff">Key Menu</th>
										...
										<tbody>
											<tr>
												...
												<td align="left" valign="left" style="text-align:left">Dashboard</td>
												<td align="left" valign="left" style="text-align:left">hrm-zona-pegawai-dashboard</td>
											...
											<tr>
												...
												<td align="left" valign="left" style="text-align:left">finance-accounting-buku-besar</td>
											...
											<tr>
											  ...
											  <td align="left" valign="left" style="text-align:left">Dashboard</td>
											  <td align="left" valign="left" style="text-align:left">operational-tepi-jalan-umum-dashboard</td>
											...
											<tr>
											  ...
											  <td align="left" valign="left" style="text-align:left">Dashboard</td>
											  <td align="left" valign="left" style="text-align:left">general-persuratan-dashboard</td>
											  <td style="text-align:center" nowrap="nowrap"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
											    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
											      <ul class="kt-nav">
											        <li class="kt-nav__item"> <a href="#" class="kt-nav__link"> <i class="kt-nav__link-icon fa fa-user-edit"></i> <span class="kt-nav__link-text">Edit</span> </a> </li>
