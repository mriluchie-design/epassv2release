					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="10%" bgcolor="#f7fcff">Nama Modul</th>
											  <th width="10%" bgcolor="#f7fcff">Sub Modul</th>
											  <th width="10%" bgcolor="#f7fcff">Nama Menu</th>
											  <th width="10%" bgcolor="#f7fcff">Sub Menu</th>
											  <th width="20%" bgcolor="#f7fcff">Key Sub Menu</th>
										...
										<tbody>
											<tr>
												<td width="1%">1</td>
												<td align="left" valign="left" style="text-align:left">Human Resource Management</td>
												<td align="left" valign="left" style="text-align:left">Zona Pegawai</td>
												<td align="left" valign="left" style="text-align:left">Manajemen Absensi</td>
												<td align="left" valign="left" style="text-align:left">Rekap Absen</td>
												<td align="left" valign="left" style="text-align:left">hrm-zona-pegawai-manajemen-absen-rekap-absen</td>
											...
											<tr>
												<td width="1%">2</td>
												<td align="left" valign="left" style="text-align:left">Keuangan</td>
												<td align="left" valign="left" style="text-align:left">Accounting</td>
												<td align="left" valign="left" style="text-align:left">Buku Besar</td>
												<td align="left" valign="left" style="text-align:left">Akun Perkiraan</td>
												<td align="left" valign="left" style="text-align:left">finance-accounting-buku-besar-akun-perkiraan</td>
											...
											<tr>
											  <td>3</td>
											  <td align="left" valign="left" style="text-align:left">Operasional</td>
											  <td align="left" valign="left" style="text-align:left">Tepi Jalan Umum</td>
											  <td align="left" valign="left" style="text-align:left">Mitra Juru Parkir</td>
											  <td align="left" valign="left" style="text-align:left">Data Mitra Juru Parkir</td>
											  <td align="left" valign="left" style="text-align:left">operational-tepi-jalan-umum-mitra-juru-parkir-data-mitra-juru-parkir</td>
											...
											<tr>
											  <td>4</td>
											  <td align="left" valign="left" style="text-align:left">General</td>
											  <td align="left" valign="left" style="text-align:left">Persuratan</td>
											  <td align="left" valign="left" style="text-align:left">Persuratan</td>
											  <td align="left" valign="left" style="text-align:left">Surat Masuk</td>
											  <td align="left" valign="left" style="text-align:left">general-persuratan-persuratan-surat-masuk</td>
											  <td style="text-align:center" nowrap="nowrap"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
											    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
											      <ul class="kt-nav">
											        <li class="kt-nav__item"> <a href="#" class="kt-nav__link"> <i class="kt-nav__link-icon fa fa-user-edit"></i> <span class="kt-nav__link-text">Edit</span> </a> </li>
									...
									<div class="modal-content">
										...
										<div class="kt-portlet__body">
											<div class="tab-content">
												...
												<div class="col-lg-6">
														<label>Pilih Sub Modul:</label>
														<select class="form-control kt-selectpicker" data-live-search="true">
			                                      <option value="2" selected="">Zona Pegawai</option>
