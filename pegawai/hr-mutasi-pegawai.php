							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="hr-mutasi-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-calculator"></i> Buat Mutasi</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Tipe Mutasi</th>
												<th colspan="2" bgcolor="#f7fcff">Jabatan</th>
											...
											<tr>
											  ...
											  <th bgcolor="#f7fcff">Nip</th>
											  <th bgcolor="#f7fcff">Tipe Pegawai</th>
											  <th width="18%" bgcolor="#f7fcff">Asal</th>
											  <th width="18%" bgcolor="#f7fcff">Tujuan</th>
											  <th width="8%" bgcolor="#f7fcff">Asal</th>
											  <th width="8%" bgcolor="#f7fcff">Tujuan</th>
												<th width="8%" bgcolor="#f7fcff">Asal </th>
												<th width="8%" bgcolor="#f7fcff">Tujuan </th>
										...
										<tbody>
											<tr>
												...
												<td width="2%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Kamal Delapan<hr>Creative Manager" data-html="true">
												...
												<td width="10%" style="text-align:center">Mutasi Jabatan</td>
												<td width="18%" style="text-align:center">Electrical Engineer Supervisor Assistant</td>
												<td width="18%" style="text-align:center">General Affair Staff</td>
												<td width="8%" style="text-align:center">Teknik</td>
												<td width="8%" style="text-align:center">HR & GA</td>

											  <td width="8%" align="center" valign="middle" style="text-align:center">Pusat</td>
											  <td width="8%" align="center" valign="middle" style="text-align:center">Pusat</td>
											  <td width="10%" style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											...
											<tr>
												...
												<td width="2%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Oklan Zulkifli,SE<hr>HR & GA Director" data-html="true">
												...
												<td width="2%" id="kt_table_1">1102019</td>
												<td width="3%" style="text-align:center">Kontrak</td>
												<td width="10%" style="text-align:center">Mutasi Kantor</td>
												<td width="18%" style="text-align:center">Electrical Engineer Supervisor Assistant</td>
												<td width="18%" style="text-align:center">General Affair Staff</td>
												<td width="8%" style="text-align:center">Teknik</td>
												<td width="8%" style="text-align:center">HR & GA</td>
											  ...
											  <td width="8%" align="center" valign="middle" style="text-align:center">Pusat</td>
											  <td width="8%" align="center" valign="middle" style="text-align:center">Sulawesi Barat</td>
											  <td width="10%" style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
										  ...
										  <tr>
												...
												<td width="2%" id="kt_table_1">1102019</td>
												<td width="3%" style="text-align:center">Kontrak</td>
												<td width="10%" style="text-align:center">Mutasi Department</td>
												<td width="18%" style="text-align:center">Electrical Engineer Supervisor Assistant</td>
												<td width="18%" style="text-align:center">General Affair Staff</td>
												<td width="8%" style="text-align:center">Teknik</td>
												<td width="8%" style="text-align:center">HR & GA</td>
										  ...
										  <tr>
												...
												<td width="2%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Maghfirah Sharifudin Andy Omar S.Psi<hr>HR Supervisor" data-html="true">
