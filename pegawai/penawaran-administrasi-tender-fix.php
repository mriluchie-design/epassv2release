...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
  ...
  <tr style="text-align:center">
    <td width="1%" bgcolor="#e3f5fd" >NO</td>
    <td width="2%" bgcolor="#e3f5fd">NOMOR AKTA</td>
    <td width="5%" bgcolor="#e3f5fd">TANGGAL AKTA</td>
    <td width="8%" bgcolor="#e3f5fd">NOTARIS</td>
    <td width="1%" bgcolor="#e3f5fd">FILE</td>
    <td width="10%" bgcolor="#e3f5fd">KETERANGAN</td>
    <td width="2%" bgcolor="#e3f5fd">AKSI</td>
   
  </tr>
  <tr>
    <td style="text-align:center">1</td>
    <td style="text-align:center">112</td>
    <td width="5%">24 September 2008</td>
    <td width="8%">Mardiana Kadir, SH</td>
    <td width="1%" style="text-align:center"><button type="button" class="btn btn-outline-brand btn-elevate btn-sm btn-icon"><i class="la la-cloud-download"></i></button></td>
    <td width="10%">Akta Perubahan Terakhir</td>
    <td width="2%" style="text-align:center; vertical-align:center;"><div class="kt-widget2__checkbox">
  ...
  <tr>
    ...
    <td width="10%">&nbsp;</td>
    <td width="2%" style="text-align:center"><div class="kt-widget2__checkbox">
																		<label class="kt-checkbox kt-checkbox--solid kt-checkbox--single">
																			<input type="checkbox">
																			<span></span>
																		</label>
