							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="hr-lembur-add.php" class="btn btn-info btn-sm">
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th colspan="3" bgcolor="#f7fcff">Pemberi Tugas</th>
											...
											<tr>
											  ...
											  <th width="2%" bgcolor="#f7fcff">Pegawai</th>
											  <th width="2%" bgcolor="#f7fcff">Nip</th>
											  <th width="3%" bgcolor="#f7fcff">Tipe Pegawai</th>
											  <th width="16%" bgcolor="#f7fcff">Department</th>
										...
										<tbody>
											<tr>
												...
												<td width="2%" align="center" valign="middle" style="text-align:center">1102019</td>
												<td width="16%" align="center" valign="middle" style="text-align:center">Commercial &amp; Business Development</td>
												<td width="2%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par<hr>Electrical Engineer Supervisor Assistant" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
												...
												<td width="8%" style="text-align:center">18:00 WITA</td>
												<td width="8%" style="text-align:center">21:00 WITA</td>
											  ...
											  <td width="3%" style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Disetujui<hr>Muhammad Nasrullah, S.Kom<br>31 Desember 2018 - 14:30 WITA" data-html="true">
												...
												<td width="3%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-lembur.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="hapus-lembur.php" class="kt-nav__link">
											...
											<tr>
												...
												<td align="center" valign="middle" style="text-align:center">1102019</td>
												<td align="center" valign="middle" style="text-align:center">Commercial &amp; Business Development</td>
												<td width="2%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par<hr>Electrical Engineer Supervisor Assistant" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
												<td width="2%" id="kt_table_1">1102019</td>
