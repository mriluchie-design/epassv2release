                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
                    ...
                    <div class="kt-portlet__body">
                      <div class="row">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Diri</div>
										 <div class="kt-portlet__body">
                     ...
                     <div class="form-group row">
											 <div class="col-lg-2">
					                           ...
					                           <div class="form-group">
					                         <select class="form-control kt-selectpicker form-control-sm" name="param">
                       ...
                       <div class="col-lg-2">
                         ...
                         <select class="form-control kt-selectpicker">
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Pensiun</div>
							<div>&nbsp;</div>
										<div class="kt-portlet__body">
											<div class="form-group row">
                        <div class="col-lg-3">
                          <label>Departement :</label>
													<select class="form-control kt-selectpicker">
																	<option value="AK">Commercial & Business Development</option>
																	<option value="HI">Electrical Engineer Supervisor Assistant</option>
																	<option value="HI">General Affair Staff</option>
															</select>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <select class="form-control kt-selectpicker">
												...
												<div class="col-lg-3">
                          <label class="">Waktu Pengajuan :</label>
                          <div class="form-group">
														<div class="input-group date">
				                        <input type="email" class="form-control form-control-sm" placeholder="12 Oktober 2019 09:00 WITA" disabled>
															<div class="input-group-append">
																<span class="input-group-text">
																	<i class="la la-calendar-check-o"></i>
																</span>
                          ...
                          <div class="form-group">
													...
													<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
													<div class="col-lg-3">
	                          <label class="">No. SK Pensiun</label>
	                          <div class="form-group">
															<input type="text" class="form-control form-control-sm" placeholder="1/SKP-IM/X/2019" disabled>
			                      </div>
	                      </div>
