                       ...
                       <div class="col-lg-2">
                         ...
                         <select class="form-control kt-selectpicker">
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Alamat Korespondensi</div>
							<div>&nbsp;</div>
										<div class="kt-portlet__body">
											<div class="form-group row">
                        <div class="col-lg-4">
						...
						<div class="col-lg-2">
                          ...
                          <div class="form-group">
                        <input type="text" class="form-control form-control-sm" placeholder="Development">
                      </div>
                        </div>
						<div class="col-lg-2">
                          <label class="">No. Tlp Rumah :</label>
                          <div class="form-group">
                        <input type="text" class="form-control form-control-sm" placeholder="Development">
                      </div>
                        </div>
