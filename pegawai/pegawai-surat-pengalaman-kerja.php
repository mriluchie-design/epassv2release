									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="5%" rowspan="2" bgcolor="#f7fcff">No. Surat <br>Pengalaman Kerja</th>
												<th width="8%" rowspan="2" bgcolor="#f7fcff">Tanggal Surat<br>Pengunduran Diri</th>
												<th width="8%" rowspan="2" bgcolor="#f7fcff">Tanggal Resign <br>Pegawai</th>
												<th width="22%" rowspan="2" bgcolor="#f7fcff">Keterangan</th>
											...
											<tr>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="hr-cetak-pengalaman.php" class="kt-nav__link">
																		...
																		<li class="kt-nav__item">
																			<a href="#" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Cetak Surat Pengalaman</span>
																			</a>
																		</li>
