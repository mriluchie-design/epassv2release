											...
											<div class="kt-portlet__body">
												<div class="form-group row">
													<div class="col-lg-2">
														...
														<input type="email" class="form-control form-control-sm" disabled="disabled" placeholder="Disabled input">
													</div>
													<div class="col-lg-2">
												...
												<div class="form-group row">
													...
													<div class="col-lg-4">
														<label class="">Lokasi Pelaksanaan :</label>
														<input type="email" class="form-control form-control-sm" placeholder="Masukkan Lokasi Proyek">
													</div>
												</div>
												<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
