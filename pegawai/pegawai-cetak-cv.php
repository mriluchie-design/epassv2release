...
function goBack() {
				...
				<!--end::Nav-->
						...
						<table align="center" border="0" cellpadding="1" style="width: 600px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 12px;">
							...
							<tr>
							  ...
							  <td width="113" rowspan="7" align="center" valign="top"><img src="../assets/img/users/100_15.jpg" width="100" height="100"></td>
  </tr>
							<tr>
							  <td valign="top">&nbsp;</td>
							  <td valign="top">&nbsp;</td>
  ...
  <table align="center" border="0" cellpadding="1" style="width: 600px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 12px;">
							<tr>
							  <td width="570"  valign="top" style="border-bottom:1px solid #333333"><b>C. DATA KELUARGA</b></td>
  </tr>
							<tr>
							  <td  valign="top">&nbsp;</td>
  </tr>
...
<tr style="height: 10px"><td></td></tr>
  ...
  <img src="../assets/img/footer-aksikode-release.png" style="width:676px; display:block; margin-left:auto; margin-top: 0px; margin-right:auto;margin-bottom:0px;padding-bottom:0px" />
            </tr>
...
<tr style="height: 10px"><td></td></tr>
  ...
  <img src="../assets/img/footer-aksikode-release.png" style="width:676; display:block; margin-left:auto; margin-top: 10px; margin-right:auto;margin-bottom:20px;padding-bottom:30px" />
					</div>
  <div class="bg-white w-50 ml-auto mr-auto">
	<img src="../assets/img/header.png" style="width:747px; display:block; margin-left:40px;margin-right:auto;margin-bottom:40px;padding-top:40px;"/>
  ...
  <table align="center" border="0" cellpadding="1" style="width: 600px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 12px;">
							...
							<tr>
							  ...
							  <td width="7" >&nbsp;</td>
							  <td width="13" >&nbsp;</td>
							  <td width="232">[Tempat, Tanggal Saat Cetak]</td>
  </tr>
							...
							<tr>
							  ...
							  <td valign="top">&nbsp;</td>
							  <td valign="top">&nbsp;</td>
							  <td valign="top">HR & GA Director</td>
  </tr>
							<tr>
...
<tr style="height: 10px"><td></td></tr>
  ...
  <img src="../assets/img/footer-aksikode-release.png" style="width:676px; display:block; margin-left:auto; margin-top: 10px; margin-right:auto;margin-bottom:20px;padding-bottom:30px" />
					</div>
