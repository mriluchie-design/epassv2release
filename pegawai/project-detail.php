										...
										<div class="kt-widget__top">
											...
											<div class="kt-widget__content">
												<div class="kt-widget__head">
													...
													<a href="#" class="kt-widget__title">Epass Management System</a>
												...
												<div class="kt-widget__info">
													...
													<div class="kt-widget__stats d-flex align-items-center flex-fill">
														...
														<div class="kt-widget__item">
															...
															<div class="kt-widget__label">
																<span class="btn btn-label-brand btn-sm btn-bold btn-upper">Application</span>
															</div>
														</div>
														<div class="kt-widget__item flex-fill">
															<span class="kt-widget__subtitel">Progress Keseluruhan</span>
															<div class="kt-widget__progress d-flex  align-items-center">
																<div class="progress" style="height: 5px;width: 100%;">
																	<div class="progress-bar progress-bar-striped progress-bar-animated bg-warning " role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 39%"></div>
																</div>
										...
										<div class="kt-widget__bottom">
											<div class="kt-widget__item">
												...
												<div class="kt-widget__details">
													<span class="kt-widget__title">Pengeluaran Proyek</span>
													<span class="kt-widget__value"><span>Rp.</span> 164.700,-</span>
												</div>
											</div>
											<div class="kt-widget__item">
												<div class="kt-widget__icon">
												...
												<div class="kt-widget__details">
													<span class="kt-widget__title">Administrasi Penawaran</span>
													<div class="kt-widget__progress d-flex  align-items-center">
																<div class="progress" style="height: 5px;width: 100%;">
											...
											<div class="kt-widget__item">
												...
												<div class="kt-widget__details">
													<span class="kt-widget__title">Administrasi Pelaksanaan</span>
													<div class="kt-widget__progress d-flex  align-items-center">
																<div class="progress" style="height: 5px;width: 100%;">
																	<div class="progress-bar progress-bar-striped progress-bar-animated bg-warning " role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 30%"></div>
																</div>&nbsp;&nbsp;&nbsp;
																<span class="kt-widget__stat">
																	30%
																</span>
											...
											<div class="kt-widget__item">
												...
												<div class="kt-widget__details">
													<span class="kt-widget__title">Administrasi Keuangan</span>
													<div class="kt-widget__progress d-flex  align-items-center">
																<div class="progress" style="height: 5px;width: 100%;">
																	<div class="progress-bar progress-bar-striped progress-bar-animated bg-danger " role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 10%"></div>
																</div>&nbsp;&nbsp;&nbsp;
																<span class="kt-widget__stat">
																	10%
																</span>
														...
														<div class="kt-widget31__item">
															...
															<div class="kt-widget31__content">
																<div class="kt-widget31__progress">
																	...
																	<div class="progress progress-sm">
																		<div class="progress-bar bg-warning" role="progressbar" style="width: 13%" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
																	</div>
																</div>
																<div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
														...
														<div class="kt-widget31__item">
															...
															<div class="kt-widget31__content">
																<div class="kt-widget31__progress">
																	...
																	<div class="progress progress-sm">
																		<div class="progress-bar bg-danger" role="progressbar" style="width: 10%" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
																	</div>
																</div>
																<div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
