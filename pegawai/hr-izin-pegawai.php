							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="hr-izin-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-calculator"></i> Buat Izin</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Jenis Izin</th>
										...
										<tbody>
											<tr>
												...
												<td width="10%">Jam Kerja</td>
												<td width="8%" style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											  <td width="8%" style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											  <td width="8%" style="text-align:center">12 Oktober 2019<br>12:00 WITA</td>
										  ...
										  <tr>
												...
												<td width="3%" style="text-align:center">Kontrak</td>
												<td width="15%" style="text-align:center">Commercial & Business Development</td>
												<td width="10%">Terlambat Datang</td>
												<td width="8%" style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											  <td width="8%" style="text-align:center">12 Oktober 2019<br>09:00 WITA</td>
											  <td width="8%" style="text-align:center">12 Oktober 2019<br>12:00 WITA</td>
