                       ...
                       <div class="col-lg-2">
                         ...
                         <select class="form-control kt-selectpicker">
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Mutasi</div>
							<div>&nbsp;</div>
										<div class="kt-portlet__body">
											<div class="form-group row">
                        <div class="col-lg-2">
                          <label>Jenis Mutasi :</label>
													<select class="form-control kt-selectpicker">
																	<option value="AK">Mutasi Jabatan</option>
																	<option value="HI">Mutasi Kantor</option>
																	<option value="HI">Mutasi Department</option>
															</select>
                        </div>
                        <div class="col-lg-3">
                          ...
                          <div class="form-group">
                        <select class="form-control kt-selectpicker">
																<option value="AK">Electrical Engineer Supervisor Assistant</option>
                          ...
                          <div class="form-group">
                        <select class="form-control kt-selectpicker">
																<option value="AK">General Affair Staff</option>
