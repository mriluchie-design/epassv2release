...
function goBack() {
  ...
  <tr>
    <td colspan="6" style="text-align: center"><strong><U>DATA HISTORY STICKER KENDARAAN<U></strong></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td width="9%">Cabang</td>
    <td width="2%" style="text-align: center">:</td>
    <td>Makassar</td>
  </tr>
  
  <tr>
    <td width="9%">No. Plat Kendaraan</td>
    <td style="text-align: center">:</td>
    <td>DD 1111 LU</td>
  </tr>
  <tr>
    <td width="9%">Penanggung Jawab</td>
    <td width="2%" style="text-align: center">:</td>
