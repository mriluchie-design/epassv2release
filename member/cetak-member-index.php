...
function goBack() {
  ...
  <tr>
    <td colspan="7" style="text-align: center"><strong><U>DATA MEMBER PASS TAHUNAN<U></strong></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td width="3%">Cabang</td>
    <td width="2%" style="text-align: center">:</td>
    <td width="10%">Makassar</td>
    <td width="3%">&nbsp;</td>
    <td width="5%">Status Member</td>
    <td style="text-align: center">:</td>
    <td width="38%">Keseluruhan</td>
  </tr>
  
  <tr>
    <td width="3%">Periode</td>
    <td style="text-align: center">:</td>
    <td width="10%">01/01/2025 s/d 31/01/2025</td>
    <td width="3%">&nbsp;</td>
    <td width="1%">Kategori Member</td>
    <td width="2%" style="text-align: center">:</td>
    <td width="38%">Keseluruhan</td>
  </tr>
  <tr>
    <td width="5%">Penanggung Jawab</td>
    <td width="2%" style="text-align: center">:</td>
    <td width="10%">Keseluruhan</td>
    <td width="3%">&nbsp;</td>
    <td width="5%">No. Plat Kendaraan</td>
    <td style="text-align: center">:</td>
    <td width="38%">Keseluruhan</td>
  </tr>
  <tr>
...
<table align="center" border="1" cellpadding="5" style="width: 1450px; position:relative;top:70px; text-align:justify; line-height:1.5; font-family: Roboto; font-size: 11px;">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Sticker Member</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Penanggung Jawab</th>
											  <th colspan="5" bgcolor="#f7fcff">Kendaraan</th>
											  <th colspan="3" bgcolor="#f7fcff">Pembayaran</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="1%" bgcolor="#f7fcff">Kategori</th>
											  <th width="1%" bgcolor="#f7fcff">No. Plat</th>
											  <th width="1%" bgcolor="#f7fcff">Waktu Registrasi</th>
											  <th width="2%" bgcolor="#f7fcff">Aktif Hingga</th>
											  <th width="1%" bgcolor="#f7fcff">Status</th>
											  <th width="2%" bgcolor="#f7fcff">ID Reff</th>
											  <th width="2%" bgcolor="#f7fcff">Metode</th>
											  <th width="3%" bgcolor="#f7fcff">Provider</th>
										  </tr>
										</thead>
										<tbody>
											<tr>
												...
												<td style="text-align:left" nowrap>12321355123123211</td>
												...
												<td nowrap="nowrap" style="text-align:center">1 September 2026 - 15:36:00 WITA</td>
												<td style="text-align:center">31 Desember 2026</td>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:left">12321355123123212</td>
												<td nowrap="nowrap" style="text-align:left">Muhammad Nasrullah, S.Kom</td>
...
<tr>
												...
												<td style="text-align:left" nowrap>Makassar</td>
												<td style="text-align:left" nowrap>12321355123123213</td>
												<td nowrap="nowrap" style="text-align:left">Muhammad Nasrullah, S.Kom</td>
												<td nowrap="nowrap" style="text-align:left">Sedan/Jeep/Pick Up</td>
												<td nowrap="nowrap" style="text-align:left">DD 1111 LII</td>
												<td nowrap="nowrap" style="text-align:center">1 September 2026 - 15:36:00 WITA</td>
												<td style="text-align:center">31 Desember 2025</td>
												<td style="text-align:center">Berakhir</td>
												<td nowrap="nowrap" style="text-align:center"><span class="text-center">01521531355135</span></td>
...
<tr>
  ...
  <td style="text-align:left" nowrap="nowrap">12321355123123214</td>
  <td nowrap="nowrap" style="text-align:left">Muhammad Ramadhan, ST</td>
