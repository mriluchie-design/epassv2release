							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="lupa-absen-form.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i> Buat Lupa Absen</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="8%" bgcolor="#f7fcff">Tanggal<br>Lupa Absen</th>
												<th width="7%" bgcolor="#f7fcff">Jenis Lupa Absen</th>
												<th width="8%" bgcolor="#f7fcff">Waktu<br>Pengajuan</th>
												<th width="16%" colspan="2" bgcolor="#f7fcff">Pegawai</th>
												<th width="12%" bgcolor="#f7fcff">Departemen</th>
												<th width="12%" bgcolor="#f7fcff">Divisi</th>
												<th width="12%" bgcolor="#f7fcff">Jabatan</th>
												<th width="3%" bgcolor="#f7fcff">Status Pegawai</th>
												<th width="3%" bgcolor="#f7fcff">Kantor</th>
												<th width="3%" bgcolor="#f7fcff">Verifikasi</th>
										...
										<tbody>
										  ...
										  <tr>
												...
												<td style="text-align:center">12 Oktober 2019<br />
												  09:00 WITA</td>
												<td width="3%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP : 000000000003" data-html="true">
											  ...
											  <td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="modal" data-target="#modal_persetujuan_release"data-html="true">
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<a href="detail-lupa-absen.php" class="kt-nav__link">
										  ...
										  <tr>
												...
												<td style="text-align:center">12 Oktober 2019<br />
												  09:00 WITA</td>
												<td width="3%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP : 000000000006" data-html="true">
										  ...
										  <tr>
												...
												<td style="text-align:center">12 Oktober 2019<br />
												  09:00 WITA</td>
												<td width="3%" align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="NIP : 000000000002" data-html="true">
