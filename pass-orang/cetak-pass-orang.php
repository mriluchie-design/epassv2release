...
function goBack() {
			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
				...
				<!--end::Nav-->
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-3">
								<div class="bg-white w-25 ml-auto mr-auto" style="margin-bottom:50px; margin-top:50px;">
 ...
 <tr>
    <td style="text-align: center; font-size:12px;"><strong>PASS ORANG</strong></td>
  </tr>
  <tr>
...
<table class="table-responsive" cellpadding="3" align="center" width="100" border="0" style="line-height:1; padding-top:15px; font-family: Tahoma; font-size: 12px;" id="kt_table_1">
  ...
  <tr>
    ...
    <td colspan="3" style="text-align: left">000001PTOGEM0626</td>
  </tr>
...
<table class="table-responsive" align="center" width="250px" style="margin-left:35px; margin-bottom:10px;">
        <thead>
            </thead>
        <tbody>
            <tr>
