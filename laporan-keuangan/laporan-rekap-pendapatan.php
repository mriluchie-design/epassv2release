...
<div class="tab-content" style="background:#f2f3f8;overflow:scroll;height:auto;">
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-3">
								<div class="bg-white w-50 ml-auto mr-auto">
									...
									<div>&nbsp;<div>
									<table class="table-responsive" cellpadding="3" align="center" width="250" border="0" style="line-height:1; margin-left:70px; padding-top:20px; font-family: Tahoma; font-size: 11px;" id="kt_table_1">
   <tr>
  ...
  <tr>
    <td colspan="7" style="text-align: right">&nbsp;</td>
            ...
            <tbody>
								...
								<div><span>&nbsp;</span>
   <table align="center" border="0" cellpadding="1" style="text-align:center; line-height:1.5; font-family: Tahoma; font-size: 12px; margin-top:150px; margin-left:130px; margin-bottom:50px;">
