...
function goBack() {
  window.history.back();
			...
			<a href="cetak-keuangan-karcis-muatan-kapal.php" class="btn btn-label-success btn-sm">
		...
		<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <!-- end:: Alert -->
				...
				<div class="col-lg-4">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Kendaraan Muatan Kapal</div><br><br>
										 <div class="kt-portlet__body">
                      ...
                      <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="000001MKTEM0626">
																  </div>
						<div class="col-lg-6">
                          <label class="">ID Pembayaran :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="000007PMKTEM0626">
																  </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
                      <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="000009PGTEM0626">
																  </div>
						<div class="col-lg-6">
					  ...
					  <div class="col-lg-2">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--brand">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Job Delivery</div><br><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row" style="text-align:center">
																					<div class="col-lg-12">
																						<div>&nbsp;</div>
														<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
																			<div class="kt-avatar__holder" style="width:200px; height:200px; background-image: url(../assets/media/kendaraan/job-delivery.jpg);"></div>
