    ...
    <td width="50%"><div class="col-lg-12">
				...
				<form class="kt-margin-l-20" id="kt_subheader_search_form">
										...
										<div class="kt-portlet__body"><br>
											...
											<figure class="highcharts-figure">
													<div id="container-cabang-pendapatan" style="height:400px"></div>
											</figure>
										</div>
									</div>
						</div></td>
    <td width="50%"><div class="col-lg-12">
					...
					By Kategori Transaksi </span>
										...
										<div class="kt-portlet__body"><br>
											<figure class="highcharts-figure">
											<figure class="highcharts-figure">
													<div id="container-cabang-pendapatan-kategori" style="height:400px"></div>
											</figure>
										</div>
									</div>
						</div></td>
    ...
    <td><div class="col-lg-12">
					...
					Member / Pass Tahunan </span>
										...
										<div class="kt-portlet__body">
											<figure class="highcharts-figure">
										    <div id="container-cabang-pendapatan-member" style="height:400px"></div>
										</figure>
										</div>
									</div>
						</div></td>
...
<?php require '../layouts/footer.php' ?>
						...
						<script src="../assets/js/chart/cabang-monitoring-pendapatan.js" type="text/javascript"></script>
						<script src="../assets/js/chart/cabang-monitoring-pendapatan-member.js" type="text/javascript"></script>
						<script src="../assets/js/chart/highchart-detail-pendapatan-member.js" type="text/javascript"></script>
						<script src="../assets/js/chart/cabang-monitoring-pendapatan-kategori.js" type="text/javascript"></script>
