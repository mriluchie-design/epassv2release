													...
													<div class="kt-widget17__items">
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:17px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 11.688.808,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:17px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 11.000.000,-</span>
															</span>
														</div>
														...
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:17px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 688.808,-</span>
															</span>
														</div>
...
<table class="table-checkable" cellpadding="3" align="center" width="1450" style="line-height:1.5; margin-left:63px; position:relative;top:0px; font-family: Tahoma; font-size: 12px;">
  <tr>
    <td width="50%"><div class="col-lg-12">
				...
				<form class="kt-margin-l-20" id="kt_subheader_search_form">
										...
										<div class="kt-portlet__body"><br>
											...
											<figure class="highcharts-figure">
													<div id="container-cabang-monitoring-pendapatan-harian" style="height:300px"></div>
											</figure>
										</div>
									</div>
						</div></td>
    <td width="50%"><div class="col-lg-12">
					...
					By Provider</span>
										...
										<div class="kt-portlet__body">
											<figure class="highcharts-figure">
										    <div id="container-cabang-monitoring-transaksi-provider" style="height:332px"></div>
										</figure>
										</div>
									</div>
						</div></td>
  ...
  <tr>
    <td width="50%"><div class="col-lg-12">
					...
					Member </span>
										...
										<div class="kt-portlet__body">
											<figure class="highcharts-figure">
										    <div id="container-detail-pendapatan-member" style="height:330px"></div>
										</figure>
										</div>
									</div>
						</div></td>
