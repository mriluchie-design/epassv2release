                ...
                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
                    ...
                    <ul class="kt-nav">
                        <li class="kt-nav__item">
                            <a href="cetak_monitoring_pendapatan_harian.php" class="kt-nav__link">
										...
										<div class="kt-portlet__head kt-portlet__head--noborder kt-portlet__space-x">
											...
											<div class="kt-portlet__head-toolbar" style="margin-right:55px;">
												<a href="#" class="btn btn-label-light btn-sm " >
													Periode : 10/6/2026 s/d 10/6/2026
												</a>
													...
													<div class="kt-widget17__items">
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 11.738.808,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 11.000.000,-</span>
															</span>
														</div>
														...
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 0,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
														...
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 688.808,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 50.000,-</span>
															</span>
														</div>
						...
						<div class="col-lg-6">
							<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													Pendapatan&nbsp;&nbsp;|&nbsp;&nbsp;<span class="kt-subheader__desc" id="kt_subheader_total" style="color:#ff0000">
					By Transaksi </span>
				<form class="kt-margin-l-20" id="kt_subheader_search_form">
												</h3>
											</div>
										...
										<div class="kt-portlet__body"><br>
											...
											<figure class="highcharts-figure">
													<div id="container-cabang-monitoring-pendapatan-harian" style="height:400px"></div>
											</figure>
										</div>
									</div>
						</div>
						<div class="col-lg-6">
							<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													Pembayaran &nbsp;&nbsp;|&nbsp;&nbsp;<span class="kt-subheader__desc" id="kt_subheader_total" style="color:#ff0000">
					By Provider</span>
												</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
										...
										<div class="kt-portlet__body">
											<figure class="highcharts-figure">
										    <div id="container-cabang-monitoring-transaksi-provider" style="height:400px"></div>
										</figure>
										</div>
									</div>
						</div>
					...
					<div>&nbsp;</div>
						...
						<script src="../assets/js/chart/cabang-monitoring-pendapatan-harian.js" type="text/javascript"></script>
						<script src="../assets/js/chart/cabang-monitoring-transaksi-provider.js" type="text/javascript"></script>
