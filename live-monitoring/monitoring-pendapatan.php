								...
								<span class="kt-subheader__separator kt-subheader__separator--v"></span>
									<div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total" style="color:#ff0000">
											 Pendapatan Seluruh Cabang </span>
													...
													<div class="kt-widget17__items">
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 19.919.827.500,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 12.809.307.755,-</span>
															</span>
														</div>
														...
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 3.832.193.650,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc" style="text-align:center">
																<span style="color:#ed1c24; font-size:15px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 3.278.326.095,-</span>
															</span>
														</div>
<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
						...
						<div class="col-lg-6">
							<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													Rekap Pendapatan &nbsp;&nbsp;|&nbsp;&nbsp;<span class="kt-subheader__desc" id="kt_subheader_total" style="color:#ff0000">
					By Kategori </span>
				<form class="kt-margin-l-20" id="kt_subheader_search_form">
												</h3>
											</div>
										...
										<div class="kt-portlet__body"><br>
											<figure class="highcharts-figure">
													<div id="container-pendapatan-kategori-all" style="height:400px"></div>
											</figure>
										</div>
									</div>
						</div>
