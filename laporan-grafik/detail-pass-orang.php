...
function goBack() {
  window.history.back();
			...
			<a href="cetak-pass-orang.php" class="btn btn-label-success btn-sm">
                    <i class="fa fa-print"></i> Cetak Pass Orang</button>
                    <!--<i class="flaticon2-plus"></i>-->
                </a>
		...
		<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <!-- end:: Alert -->
				...
				<div class="col-lg-6">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Pass Orang</div><br><br>
										 <div class="kt-portlet__body">
                      ...
                      <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="001TRORGEM0526">
																  </div>
						<div class="col-lg-6">
                          <label class="">ID Pembayaran :</label>
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="000001PTOGEM0626">
																  </div>
                        </div>
						<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
						<div class="form-group row">
