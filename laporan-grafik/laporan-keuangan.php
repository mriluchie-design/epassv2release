					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="2%" rowspan="2" bgcolor="#f7fcff">Jumlah Durasi<br> Jam Parkir<br>
											    (Pembulatan)</th>
										...
										<tbody>
											<tr>
											  ...
											  <td colspan="9" nowrap style="text-align:left"><strong>Data Kendaraan Keluar</strong></td>
										  </tr>
											<tr>
										  ...
										  <tr>
										    <td bgcolor="#f7fcff" style="text-align:right" colspan="8" id="kt_table_10"><b>Grand Total</b></td>
										  ...
										  <tr>
										    <td bgcolor="#f7fcff" style="text-align:left" colspan="10" id="kt_table_2"><em><strong>Terbilang : Sembilan Juta Seratus Sembilan Puluh Delapan Ribu Rupiah</strong></em></td>
									      </tr>
  </tbody>
									</table>
                    <!--end: Datatable -->
