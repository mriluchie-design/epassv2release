			...
			<div class="row">
						...
						<div class="col-lg-2">
							<div class="kt-portlet kt-portlet--height-fluid">
										...
										<div class="kt-portlet__body">
											<figure class="highcharts-figure">
										    <div id="container-cabang-gate-1-keluar" style="height:300"></div>
										</figure>
										</div>
									</div>
						</div>
						<div class="col-lg-2">
							<div class="kt-portlet kt-portlet--height-fluid">
										...
										<div class="kt-portlet__body">
											<figure class="highcharts-figure">
										    <div id="container-cabang-gate-2-keluar" style="height:300"></div>
										</figure>
										</div>
									</div>
						</div>
						<div class="col-lg-2">
							<div class="kt-portlet kt-portlet--height-fluid">
										...
										<div class="kt-portlet__body">
											<figure class="highcharts-figure">
										    <div id="container-cabang-gate-3-keluar" style="height:300"></div>
										</figure>
										</div>
									</div>
						</div>
						...
						<script src="../assets/js/chart/cabang-grafik-gate-1-keluar.js" type="text/javascript"></script>
						<script src="../assets/js/chart/cabang-grafik-gate-2-keluar.js" type="text/javascript"></script>
						<script src="../assets/js/chart/cabang-grafik-gate-3-keluar.js" type="text/javascript"></script>
